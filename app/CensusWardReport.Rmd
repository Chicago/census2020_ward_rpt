...
map1 <- tm_shape(ward_sf, is.master = TRUE) + 
  tm_polygons(col = "low_response_score", palette = c("#FFFFFF","#22556F"), style="cont", alpha = .7, title = "Low       Response Score", breaks=breaks, popup.var = popups, group = "Relevant Ward Census Tracts") +
