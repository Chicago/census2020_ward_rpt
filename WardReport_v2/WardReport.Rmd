                ...
                j = list(LABEL = htmltools::HTML(
                  paste(paste0("Tract: ", TRACT),
                        ...
                        paste0("Households in ward: ",
                               prettyNum(TotHH*households_ward/households_tract, 
                                         big.mark=",")),
                        paste0("2010 mail return rate: ", mail_return_rate_cen_2010, "%"),
                        paste0("Census predicted 2020 response:", 100-low_response_score, "%"),
...
# pal <- colorNumeric(palette = cur_pal, domain = vec)K
