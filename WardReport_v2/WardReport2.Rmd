...
load("data_ward_report_cache/2020-03-30.RData")
cur_wrd <- 2
```
...
## Add in civis pdb data
ward_spdf@data <- cbind(ward_spdf@data,
                        civis_pdb[match(tracts_in_ward, tract)],
                        resp_current[match(tracts_in_ward, TRACT),
...
YlOrRd <- function(x) rgb(colorRamp(c("#fff7ba", "#fee28a", "#fec05b", "#fd923e", "#fc502a", 
                                      "#df171c", "#b00026"))(x), maxColorValue = 255)
...
output$ward_demographics <- renderReactable({
  reactable(dt2, 
...
# popups <- c("NAMELSAD", "low_response_score", "tot_population_cen_2010", 
#             "tot_housing_units_cen_2010", "nh_blk_alone_acs_13_17", 
#             "hispanic_acs_13_17", "eng_vw_acs_13_17", "HH_SingleParent")
...
#   tm_shape(ward_spdf) +
#   tm_borders(col = "blue", lwd=3, group = paste0("Ward ", cur_wrd, " Outline"))
```
