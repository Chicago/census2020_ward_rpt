...
def create_new_email_script(client,ward_email_data, ward_number, report_date, folder_name):
    new_script = client.scripts.post_python3(name = 'City_Ward_'+str(ward_number) + '_Report',
                                source = create_source_script(ward_email_data, ward_number, report_date, folder_name))
    return new_script
