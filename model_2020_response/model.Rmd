...
shp_tracts_2020 <- readRDS("model_2020_response/shp_tracts_2020.Rds")
shp_tracts_prev <- readRDS("model_2020_response/shp_tracts_prev.Rds")
...
## Subset GEO ID to the GEO ID that starts with "State"
## Also, recreate Tract because the leading zero gets dropped by default
resp[ , tract := NULL]
...
##------------------------------------------------------------------------------
## Demographic variables, TOTALS AND PERCENTAGE OF HOUSEHOLDS
##------------------------------------------------------------------------------
...
## Actually copied the results into Excel and made some decisions
...
## Used this to construct the data table code below
...
## Join selected demographic data to response data
